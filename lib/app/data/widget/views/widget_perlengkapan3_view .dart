...
class WidgetPerlengkapan3View extends GetView {
  ...
  final TextEditingController controllerPemeriksaanTerakhir;
  final TextEditingController controllerKeterangan;
  final terpilih;

  WidgetPerlengkapan3View({
    Key? key,
    ...
    required this.controllerPemeriksaanTerakhir,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          WidgetFormFieldView(
            Title: 'PemeriksaanTerakhir',
            controller: controllerPemeriksaanTerakhir,
          ),
          WidgetFormFieldView(
            Title: 'Keterangan',
