...
class WidgetPerlengkapan2View extends GetView {
  ...
  final TextEditingController controllerTipe;
  final TextEditingController controllerKeterangan;
  final terpilih;

  WidgetPerlengkapan2View({
    Key? key,
